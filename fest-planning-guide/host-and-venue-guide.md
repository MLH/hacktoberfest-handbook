...
This guide is for venue partners, school administrators, Meet Up leads, and others helping an organizer run an in-person Fest.

## Purpose and Educational Benefits

Fests are short, one-day events that give participants hands-on experience with open-source and open-weight AI. They last 3 to 12 hours and do not require an overnight stay or multi-day commitment.
...
* **Program format:** Hacktoberfest Hack Day events involve project creation, submissions, and judging. Hacktoberfest Meet Up events involve talks, demonstrations, discussions, social activities, noncompetitive workshops, or another approved program.
...
* **Support:** both formats receive swag. Hacktoberfest Hack Day events also receive reimbursement under the current policy and may run prize challenges. Hacktoberfest Meet Up events do not receive reimbursement or prizes.
...
* Setup and breakdown time outside the published 3-to-12-hour program

Whenever possible, use a venue that does not require a rental fee. Hacktoberfest Hack Day reimbursement is intended for approved event expenses under the current policy, and Hacktoberfest Meet Up events do not receive reimbursement.
...
Hacktoberfest Hack Day events need enough uninterrupted time for participants to create and submit a new project during the Fest. Work may not begin before the event. Hosts can help by providing workspace, technical support, mentors, judges, and a quiet area for reviewing projects or running demos.
...
## Supporting a Hacktoberfest Meet Up

Hacktoberfest Meet Up events may include talks, panels, demonstrations, noncompetitive workshops, informal discussions, social activities, or other bespoke programming. Hosts can help with microphones, presentation screens, seating, speaker support, and transitions between sessions.

Hacktoberfest Meet Up events receive swag, but no prizes or reimbursement.
