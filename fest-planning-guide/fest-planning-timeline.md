...
* Identify one day for the event. Hacktoberfest Hack Days run for 3 to 12 hours, with four to six hours ideal; Meetup schedules should fit the approved program.
...
* Hacktoberfest Hack Day organizers: test the Challenges button, submission flow, and judging materials.
* Review the [Fest Opening Guide](fest-opening-guide.md) for the current status of the event materials.
{% endstep %}
