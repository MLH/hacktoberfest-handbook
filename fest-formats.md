...
Hacktoberfest Hack Day events are designed to give participants the opportunity to create something in a focused and structured environment. Work on submitted projects may not begin before the Fest; all submitted work must be completed during the event. Organizers can choose to run one, several, or all of our [open-source prize challenges](fest-planning-guide/open-source-prize-categories.md).
...
Some Hacktoberfest Hack Day events will also receive a Hack Days partner prize category. These categories are assigned by the MLH Hacktoberfest team. See [Hack Days Partner Prize Categories](fest-planning-guide/hack-days-partner-prize-categories.md) for the currently active categories.

### Two Types of Prize Tracks

| Prize class                      | Who selects it?                                                                                                                    | Prize                                                                                                      | Who fulfills it?                               |
| -------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------- | ---------------------------------------------- |
| Open-source prize challenge      | The Hacktoberfest Hack Day organizer may run one, several, or all challenges                                                       | One winning team per chosen challenge; every winning team member receives a DEV Badge on their DEV account | MLH team issues the DEV Badges after the event |
| Hack Days partner prize category | The MLH Hacktoberfest team assigns it to selected Hacktoberfest Hack Day events, although organizers can indicate their preference | The category-specific prize stated in the assigned event instructions.                                     | MLH team fulfills the prize after the event    |
...
{% hint style="info" %}
* Both formats must be one-day, in-person events lasting 3 to 12 hours. The reason we are only providing Fests in person is because we have other opportunities for people who want to participate online. Participants who prefer to engage online should visit [Hacktoberfest.com](https://hacktoberfest.com/) to see the full menu of virtual challenges and content that we have in store.
